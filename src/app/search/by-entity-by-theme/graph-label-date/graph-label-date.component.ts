...
@Component({
  selector: 'app-graph-label-date',
  standalone: true,
  imports: [],
  templateUrl: './graph-label-date.component.html',
  styleUrl: './graph-label-date.component.css'
})
export class GraphLabelDateComponent implements OnInit {
  ngOnInit(): void {
    this.buildChart();
  }
  private buildChart(): void {
    ...
    Plotly.newPlot('graph-label-date', traces, layout);
  }
